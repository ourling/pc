let app = new Vue({
    ...
    data: {
        banner: {url: `${GLOBAL_STATIC_URL}/images/chain/banner.png`,title: '美车供应链',titleBar:'通过美车优选的定金担保完成交易，让交易风险大大降低'},
        part01: {title: '优质车源',url: `${GLOBAL_STATIC_URL}/images/chain/part01-bg.png`},
        part02: {title: '优质车源',url: `${GLOBAL_STATIC_URL}/images/chain/part02-bg.png`,txt: '直接点，放心拍！',erwei:`${GLOBAL_STATIC_URL}/images/chain/erwei.png`},
