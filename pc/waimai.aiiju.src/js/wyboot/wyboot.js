 //var GLOBAL_STATIC_URL = location.origin;//线上静态资源路径
 var GLOBAL_STATIC_URL = "http://localhost:8999/waimai.aiiju.com";//本地静态资源路径
var GLOBAL_HOME_PATH = "/";
var GLOBAL_QIMIAOWA_VERSION = "v20171012233510";//全局上线版本号，上线时候手工改动
(function (w, d, undefined) {
    ...
    _G.loadCss(GLOBAL_STATIC_URL + '/pluginsCss/animate/animate.min.css?v=' + GLOBAL_QIMIAOWA_VERSION);
    _G.loadCss(GLOBAL_STATIC_URL + '/css/comm.css?v=' + GLOBAL_QIMIAOWA_VERSION);
    ...
    _G.loadJs(GLOBAL_STATIC_URL + '/plugins/vue/vue2.0.js?v=' + GLOBAL_QIMIAOWA_VERSION);
